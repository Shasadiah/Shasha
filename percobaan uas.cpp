...
int main()
{
   ...
   int gapok[10],glembur[10],bonus[10],pajakgapok[10],pajaklembur[10],totpajak[10],gajibersih[10];
   ...
   for (int i=1;i<=jum;i++){
	...
	gajibersih[i]=((gapok[i]+bonus[i]+glembur[i])-totpajak[i]);
	cout<<endl;
	}
	...
	for (int i=1;i<=jum;i++){
		...
		cout<<"Tunjangan Pengabdian : "<<bonus[i]<<endl;
